...
public class LandModel extends Tick implements Port {
	 ...
	 * 10元奖券
	 */
	public final static int WESTGATE = 2;
	/**
	 * 30元奖券
	 */
	 ...
	 * 乐透
	 */
	public final static int TOWER = 6;
	/**
	 * 新闻
	 */
	...
	protected int[][] land3 = {
			// 模仿大富翁其中一个地图设置
			{ ORIGIN, SHOP, WESTGATE, WESTGATE, WESTGATE, WESTGATE, TOWER, TOWER,TOWER, TOWER, LIBRARY, LIBRARY, LIBRARY },
			{ SHOP, NULL_SET, NULL_SET, NULL_SET, NULL_SET, NULL_SET, NULL_SET, NULL_SET,NULL_SET, NULL_SET, NULL_SET, NULL_SET, LIBRARY },
	...
	protected int[][] land2 = {
			...
			{ SPACE, NULL_SET, NULL_SET, NULL_SET, SHOP, SPACE, SPACE, SPACE,PARK, SPACE, SPACE, SPACE, PIONT_50 },
	...
	protected int[][] land1 = {
			...
			{ NEWS, NULL_SET, NULL_SET, NULL_SET, NEWS, NULL_SET, NULL_SET,
					NULL_SET, NULL_SET, SPACE, NEWS, SPACE, NEWS },
			{ NEWS, NULL_SET, NULL_SET, NULL_SET, NEWS, NULL_SET, NULL_SET,
			...
			{ SPACE, NULL_SET, NULL_SET, NULL_SET, SPACE, NULL_SET, NULL_SET,
					NULL_SET, NULL_SET, NULL_SET, NULL_SET, NULL_SET, SPACE },
			{ PARK, NULL_SET, NULL_SET, NULL_SET, SPACE, NULL_SET, NULL_SET,
					NULL_SET, NULL_SET, NULL_SET, NULL_SET, NULL_SET, SPACE },

			{ NEWS, SPACE, SPACE, SPACE, SHOP, SPACE, SPACE, SPACE,
					SPACE, SPACE, HOSPITAL, PIONT_50, SPACE } };

	public int[][] land4 =
			{{NULL_SET, NULL_SET, NULL_SET, NULL_SET, NULL_SET, NULL_SET, NULL_SET, NULL_SET, NULL_SET, NULL_SET, NULL_SET, NULL_SET, SPACE, SPACE, SPACE, SPACE, NULL_SET, NULL_SET},
					{NULL_SET, NULL_SET, NULL_SET, NULL_SET, NULL_SET, NULL_SET, SPACE, SPACE, SPACE, SPACE, PIONT_90, SPACE, NEWS, NULL_SET, NULL_SET, SPACE, NULL_SET, NULL_SET},
					...
					{SPACE, NULL_SET, SPACE, NULL_SET, NULL_SET, NULL_SET, SPACE, NULL_SET, NULL_SET, SPACE, SPACE, SPACE, NULL_SET, SPACE, SPACE, HOSPITAL, NULL_SET, NULL_SET},
					{SPACE, NULL_SET, SPACE, WESTGATE, SPACE, SPACE, SPACE, NULL_SET, NULL_SET, SPACE, NULL_SET, SPACE, NULL_SET, SPACE, NULL_SET, NULL_SET, NULL_SET, NULL_SET},
					{SPACE, NULL_SET, NULL_SET, NULL_SET, NULL_SET, NULL_SET, NULL_SET, NULL_SET, NULL_SET, SPACE, NULL_SET, SPACE, SPACE, SPACE, NULL_SET, NULL_SET, NULL_SET, NULL_SET},
					...
					{NULL_SET, NULL_SET, NULL_SET, SPACE, SPACE, SPACE, NULL_SET, SPACE, SPACE, NEWS, NULL_SET, NULL_SET, NULL_SET, NULL_SET, NULL_SET, NULL_SET, NULL_SET, NULL_SET},
