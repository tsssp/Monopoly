...
public class LandModel extends Tick implements Port {
    ...
    public final static int WEST_GATE = 1;
    public final static int TOWER = 1;
    public final static int LIB = 1;
    ...
    protected int[][] land1 = {
            // 模仿大富翁其中一个地图设置
            {ORIGIN, SPACE, HOSPITAL, PIONT_50, SHOP, SPACE, PRISON, SPACE, SPACE, PARK, NULL_SET, NULL_SET, NULL_SET},
            {SPACE, NULL_SET, NULL_SET, NULL_SET, SPACE, NULL_SET, NULL_SET, NULL_SET, NULL_SET, PIONT_30, SPACE, SPACE, NEWS},
            {SPACE, NULL_SET, NULL_SET, NULL_SET, SPACE, NULL_SET, NULL_SET, NULL_SET, NULL_SET, NULL_SET, NULL_SET, NULL_SET, SPACE},
            {SPACE, NULL_SET, NULL_SET, NULL_SET, SPACE, NULL_SET, NULL_SET, NULL_SET, NULL_SET, NULL_SET, NULL_SET, NULL_SET, SPACE},
            {SPACE, NULL_SET, NULL_SET, NULL_SET, SPACE, NULL_SET, NULL_SET, NULL_SET, NULL_SET, NULL_SET, NULL_SET, NULL_SET, SPACE},
            {SPACE, NULL_SET, NULL_SET, NULL_SET, SPACE, NULL_SET, NULL_SET, NULL_SET, NULL_SET, NULL_SET, NULL_SET, NULL_SET, SPACE},
            {PARK, NULL_SET, NULL_SET, NULL_SET, PIONT_30, NULL_SET, NULL_SET, NULL_SET, NULL_SET, NULL_SET, NULL_SET, NULL_SET, SPACE},
            {NEWS, PIONT_30, SPACE, SPACE, SHOP, PIONT_10, SPACE, SPACE, SPACE, SPACE, HOSPITAL, PIONT_50, SPACE}};
    ...
    protected int[][] land4 =
            {{NULL_SET, NULL_SET, NULL_SET, NULL_SET, NULL_SET, NULL_SET, NULL_SET, NULL_SET, NULL_SET, NULL_SET, NULL_SET, NULL_SET, PIONT_30, SPACE, SPACE, SPACE, NULL_SET, NULL_SET},
                    ...
                    {SPACE, NULL_SET, SPACE, WEST_GATE, SPACE, SPACE, PIONT_30, NULL_SET, NULL_SET, SPACE, NULL_SET, SPACE, NULL_SET, SPACE, NULL_SET, NULL_SET, NULL_SET, NULL_SET},
                    ...
                    {PIONT_60, SPACE, SPACE, NEWS, NULL_SET, NULL_SET, NULL_SET, NULL_SET, NULL_SET, LIB, SPACE, SPACE, SPACE, EAST_GATE, SPACE, SPACE, SPACE, SPACE},
                    ...
                    {NULL_SET, NULL_SET, NULL_SET, SPACE, NULL_SET, NULL_SET, NULL_SET, NULL_SET, NULL_SET, BAIJIANG, SPACE, NONGYUAN, SPACE, SECURITY, SPACE, SPACE, PIONT_60, SPACE},
