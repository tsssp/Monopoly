...
public class FrameConfig extends JFrame {
	...
	private JButton jbnPlayer01 = new JButton("确认角色");
	private JLabel jbnPlayerNameLabel01 = new JLabel("给它起个名字吧:");
	private JTextField jbnPlayerNameField01 = new JTextField(12);
	private JButton jbnPlayerName01 = new JButton("确认名字");

	private JButton jbnPlayer02 = new JButton("确认角色");
	private JLabel jbnPlayerNameLabel02 = new JLabel("给它起个名字吧:");
	private JTextField jbnPlayerNameField02 = new JTextField(12);
	private JButton jbnPlayerName02 = new JButton("确认名字");
	...
	public FrameConfig(WaitFrame wFrame,JFrameGame jFrameGame) {
		...
		// 添加按钮面板
		this.add(this.createButtonPanel(), BorderLayout.SOUTH);//使用center会居于右上"开始游戏"
	...
	private JTabbedPane createMainPanel() {
		...
		this.tabs.addTab("人物1",new ImageIcon("images/config/playerChoose/choose1.png"),this.createPlayer1SelectPanel());
		this.tabs.setToolTipTextAt(0, "可以选择角色及名字(￣▽￣)~*");
		this.tabs.addTab("人物2",new ImageIcon("images/config/playerChoose/choose1.png"),this.createPlayer2SelectPanel());
		this.tabs.setToolTipTextAt(1, "可以选择角色及名字(￣▽￣)~*");
		this.tabs.addTab("设置",new ImageIcon("images/config/playerChoose/choose2.png"),this.createGameSelectPanel());
		this.tabs.setToolTipTextAt(2, "可以设置游戏条件<(￣▽￣)>");
		return tabs;
	}
	...
	private Component createGameSelectPanel() {
		...
		///panel.setBackground(new Color(128,42,42));//亚麻色 但修改颜色后，界面仍是灰色

		// --------------------------------
		final JPanel dayPanel = new JPanel();
		dayPanel.setBorder(BorderFactory.createTitledBorder(""));
		JLabel day = new JLabel("在燕园的游玩时间\n(游戏天数)");
		...
		JLabel money = new JLabel("离成为PKU首富还差……好多钱(胜利金钱)");
		...
		JLabel cash = new JLabel("跨入PKU的第一天(玩家初始金钱)");
